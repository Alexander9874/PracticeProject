...
if os.path.isfile(encoding_file_path):
    ...
    print('\x1b[0;0;41m' + '{} does not exist'.format(encoding_file_path) + '\x1b[0m')
    quit()
...
if os.path.isfile(labels_fName):
    ...
    print('\x1b[0;0;41m' + '{} does not exist'.format(labels_fName) + '\x1b[0m')
    quit()
...
print('\x1b[6;0;42m' + "Saving classifier to '{}'".format(fName) + '\x1b[0m')
